          ...
          <div class="row justify-content-md-center h-100">
            <div class="card-wrapper">
              <div class="card fat" style="margin-top:30px">
                <div class="card-body">
                  <p style="margin-top:20px;font-size: 15px;"> Google's OAuth 2.0 server authenticates the user and obtains consent from the user for your application to access the requested scopes and the response is sent back to the application. If the user approves the access request, then the response contains an <span style="font-weight: 700">authorization code </span>. After the web server receives the authorization code, it can it for an <span style="font-weight: 700">access token </span>. Finally, the access token is used to call the Google Drive API and store the relevant file. </p>
                </div>
              </div>
            </div>
          </div>
